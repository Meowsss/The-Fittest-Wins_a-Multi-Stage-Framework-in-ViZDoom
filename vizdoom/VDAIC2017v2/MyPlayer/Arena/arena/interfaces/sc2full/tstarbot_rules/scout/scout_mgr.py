...
from .tasks import scout_task as st
from .tasks.explor_task import ScoutExploreTask
from .tasks.cruise_task import ScoutCruiseTask
from .tasks.force_scout import ScoutForcedTask
from . import oppo_monitor as om
from ..data.pool import macro_def as md
...
class ZergScoutMgr(BaseScoutMgr):
  ...
  def _dispatch_explore_task(self, dc):
    ...
    if self._rl_support:
      ...
      from .tasks.explor_task_rl import ScoutExploreTaskRL
