...
from ...combat_strategy.squad import Squad


CombatCmdType = Enum('CombatCmdType',
                     ('MOVE', 'ATTACK', 'DEFEND', 'RALLY', 'ROCK'))
...
class CombatCommand(object):
  ...
  def __init__(self, type, squad, position):
    ...
    if isinstance(position, dict):
      ...
      assert (position is None and type == CombatCmdType.ATTACK)
