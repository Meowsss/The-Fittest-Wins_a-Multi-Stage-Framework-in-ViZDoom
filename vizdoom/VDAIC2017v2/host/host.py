...
if __name__ == "__main__":
    ...
    parser.add_argument('-rs', '--respawn', metavar="RESPAWN_DELAY", dest='respawn_delay',
                        default=10, type=int,
                        help='respawn time')
    ...
    parser.add_argument('-mode', '--mode', metavar="MODE", dest='mode',
                        default=1, type=int,
                        help='1 for PLAYER, 2 for ASYNC_PLAYER, 3 for SPECTATOR, 4 for ASYNC_SPECTATOR')
    ...
    game.add_game_args("-deathmatch +viz_nocheat 1 +viz_debug 0")
    game.add_game_args("+viz_respawn_delay {}".format(respawn))
    ...
    def gather_log():
        ...
        for player_i in range(2, player_count + 1):
            ...
            # name = game.get_game_variable(eval("vzd.GameVariable.USER{}".format(player_i)))
